...
public abstract class CustomElement {
	...
	/** Lets code check which objects are in front of others */
	protected int height = 0;

	/** Lest us know if we are able to change this element's color*/
	protected boolean editable = true;

	/** keeping trach of color since getting it from paint was bugging out */
	protected int paintColor;

	/** the ctor requires that you give the object a name and a color */
	public CustomElement(String name, int color, int height, boolean editable) {
